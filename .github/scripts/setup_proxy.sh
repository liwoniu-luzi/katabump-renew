...
# Supports hysteria:// links with alpn parameter
...
# Install jq if missing (not used in this script but kept for compatibility)
...
PEER=""
INSECURE=0
ALPN="h3"   # Default ALPN for Hysteria 1
